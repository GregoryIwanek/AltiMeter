 ...
 * Used only within {@link RecordingSessionFragment} and {@link MapFragment}
 */
public class ScreenShotCatcher {
    ...
    /**
     * Captures current screen view as a screenshot. Case with GoogleMap view.
     * @param window window of the activity which view is about to capture;
     * @param resolver activity's (which view is captured) content resolver;
     * @param textViewContent text view's texts required to created message in share action;
     ...
     */
    private void captureGoogleMap(final ContentResolver resolver,
                                  final Uri uri, final Window window, GoogleMap currentMap) {
